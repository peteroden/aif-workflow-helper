...
@pytest.mark.asyncio
async def test_connected_agent_id_to_name(agents_client_mock):
    ...
    result = await generalize_agent_dict(data, agents_client_mock)
...
@pytest.mark.asyncio
async def test_connected_agent_id_unknown(agents_client_mock):
...
@pytest.mark.asyncio
async def test_removes_id_and_created_at_recursively(agents_client_mock):
    data = {
        "id": "top-id",
...
@pytest.mark.asyncio
async def test_handles_list_of_dicts(agents_client_mock):
    data = [
